    ...
    return (
        ...
        <Container className="py-5">
            ...
            <Table striped bordered hover responsive className="text-center mb-5">
                <thead>
                    <tr className="body22">
                        <td scope="col" className="col-2" style={{backgroundColor:'#DF1E5A',color:'white',verticalAlign:'top'}}>Zones</td>
                        <td scope="col" className="col-4" style={{backgroundColor:'#DF1E5A',color:'white',verticalAlign:'top'}}>Countries</td>
                        <td scope="col" className="col-2" style={{backgroundColor:'#DF1E5A',color:'white',verticalAlign:'top'}}>Call Per Minute (£)</td>
                        <td scope="col" className="col-2" style={{backgroundColor:'#DF1E5A',color:'white',verticalAlign:'top'}}>Per SMS (£)</td>
                        <td scope="col" className="col-2" style={{backgroundColor:'#DF1E5A',color:'white',verticalAlign:'top'}}>Per MMS (£)</td>
                    </tr>
                </thead>
                <tbody>
                    <tr className="body22">
                        <td className="p-3"><span className="txtred">Zone 1</span> - Ireland, Isle of Man &amp; Channel Islands</td>
                    ...
                    <tr className="body22">
                        <td className="p-3"><span className="txtred">Zone 2</span> - Europe</td>
                    ...
                    <tr className="body22">
                        <td className="p-3"><span className="txtred">Zone 3</span> - Asia &amp; Pacific</td>
                    ...
                    <>
                    <tr className="body22">
                        <td className="p-3"><span className="txtred">Zone 4</span> - USA</td>
                    ...
                    <tr className="body22">
                        <td className="p-3"><span className="txtred">Zone 5</span> - Middle East</td>
                    ...
                    <tr className="body22">
                        <td className="p-3"><span className="txtred">Zone 6</span> - Rest of the World</td>
