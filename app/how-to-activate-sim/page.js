    ...
    return (
        ...
        <Container className="p-5">
            <div className="d-flex flex-md-row flex-column">
                <Image src={"/img/zoiko-owl.png"} width={380} height={260} alt="I am Zoiko" style={{height:'auto'}} />
                <div className="px-4">
                    ...
                    <p className="green18">Need Help?</p>
                    <p className="green18">Call us on <span className="txtred">+44 (0) 2071 646 399</span> or visit our Help &amp; Support page.</p>
                    <Button href="/activate" variant="outline-danger" size="lg" className="mx-5">Activate Your SIM</Button>
                    <Button variant="outline-danger" size="lg" onClick={toggleView}>{isToggled ? 'Read Less' : 'Read More'}</Button>
                </div>
            </div>
        </Container>
        {isOpen && (
