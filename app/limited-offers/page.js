...
export default function Limitedoffers () {
    return (
        ...
        <Container fluid className="p-0">
            <Image src={'/img/limited-offers.webp'} alt="Limited Offers" width={2000} height={400} style={{width:'100%'}} />
            ...
            <Container className="my-5">
                ...
                <Image src={'/img/number-slide.png'} width={400} height={60} alt="Number link" style={{width:'100%'}} />
                <Row className="mt-5">
                    <Col>
